...
//   late Stream<List<Station>> stationsStream;
...
//   Future<void> processSms(SmsMessage sms, List<Station> stations) async {
...
//         return DateTime(oneDayBefore.year, oneDayBefore.month, oneDayBefore.day,
//             hour, minute);
//       }
...
//     int j = 0;
//     for (int i = 0; i < 10; i++) {
//       final timestamp = inferDate(sms, int.parse(body.substring(j + 0, j + 2)),
//           int.parse(body.substring(j + 2, j + 4)));
//       final data = {
...
//   Future<List<Station>> synchronize() async {
...
//         "/splash": (context) => const SplashScreenState(),
//         "/main": (context) =>
//             MainScreen(stationsStream, () => listenController.add(null)),
//         "/newstation": (context) => const NewStationScreen(),
//         "/settings": (context) => const SettingsScreen(),
//       },
//       theme: ThemeData(
